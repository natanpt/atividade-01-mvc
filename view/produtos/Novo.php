...
<body>
    ...
    <form action="../../model/ProdutosModel.php?metodo=create" method="POST">
        ...
        Categoria: <input type="text" name="categoria" id="categoria" placeholder="Digite a categoria do produto" required><br><br>
